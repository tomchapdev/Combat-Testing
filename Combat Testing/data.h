...
namespace GC
{
	...
	//Tile
	const unsigned char TILE_SIZE = 16; //Tile size, in pixels
	...
	const unsigned char WALL_SIDE_WIDTH = 5; //Width of a wall side, in pixels
	const unsigned char WALL_TOP_HEIGHT = 4; //Width of a wall top, in pixels
	...
	//Room
	const unsigned char ROOM_NUM = 3; //Number of rooms
	const unsigned char ROOM_MAX_SIZE = 32; //Max size of a room, in tiles
	const unsigned char ROOM_MAX_DOORS = 4; //Max doors in a room
	...
	//Projectiles
	const unsigned char MAX_PROJECTILES = 50;
